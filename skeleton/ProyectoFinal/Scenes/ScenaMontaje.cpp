...
{
	GameObject* movible1 = new ObjetoMovible("mov1", this, gPhysics);
	...
	GameObject* movible2 = new ObjetoMovible("mov2", this, gPhysics);
	...
	GameObject* movible3 = new ObjetoMovible("mov3", this, gPhysics);
